...
public class Form_Monitoring_and_Measurement_List extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            ...
            jTable2.getColumnModel().getColumn(13).setMinWidth(180);
            jTable2.getColumnModel().getColumn(13).setPreferredWidth(180);
            jTable2.getColumnModel().getColumn(13).setMaxWidth(180);
            jTable2.getColumnModel().getColumn(14).setMinWidth(180);
            jTable2.getColumnModel().getColumn(14).setPreferredWidth(180);
            jTable2.getColumnModel().getColumn(14).setMaxWidth(180);
