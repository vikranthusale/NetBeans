 ...
 * @author Kamod
 */
public class Form_Payment_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Payment_List
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of  Payment");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Payment No", "Date Of Entry", "Name", "Debit (Given)(Rs.)", "Credit (Taken)(Rs.)", "Description", "Actual  Date Of entry", "Actual Time", "User"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Payment_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
