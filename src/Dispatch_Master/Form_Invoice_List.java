 ...
 * @author Kamod
 */
public class Form_Invoice_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Invoice_List
     */
    public Form_Invoice_List() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of   Invoice");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Invoice_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
