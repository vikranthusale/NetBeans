 ...
 * @author Admin
 */
public class Form_Production_Planning_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Production_Planning_List
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of  Production Planning");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "W.O.No.", "Date Of Planning", "Product Name", "Drawing No.", "Rev No.", "Product Code", "Customer Name", "Project No.", "Production Order No", "Cust. Order Qty(Nos.)", "Planned Qty(Nos)", "Order Type", "Date Of Entry", "Actual Time ", "User"
            }
        ));
        jTable2.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jTable2.setMinimumSize(new java.awt.Dimension(600, 405));
        jTable2.setPreferredSize(new java.awt.Dimension(1850, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Production_Planning_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
