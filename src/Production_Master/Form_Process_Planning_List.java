 ...
 * @author Admin
 */
public class Form_Process_Planning_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Process_Planning_List
     */
    public Form_Process_Planning_List() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date Of Planning", "Product Name", "Part Code", "Drawing No.", "Rev No.", "Sr No.", "Parameter (Dim.)", "Working Side", "Method", "Mean Value", "Unit", "Lower Limit", "Upper Limit", "Inspection Instrument", "Process Name", "Process Code", "Machine Name", "Machine  No.", "Manufacturing Tool", "Ins. Sample Qty", "Mea. Sample Qty", "Parameter To Be Measured InProcess", "Parameter To Be Measured In Final Inspection", "Actual Date Of Entry", "Actual Time ", "User"
            }
        ));
        jTable2.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jTable2.setMinimumSize(new java.awt.Dimension(600, 405));
        jTable2.setPreferredSize(new java.awt.Dimension(3550, 400));
        ...
        if (jTable2.getColumnModel().getColumnCount() > 0) {
            ...
            jTable2.getColumnModel().getColumn(21).setMinWidth(250);
            jTable2.getColumnModel().getColumn(22).setMinWidth(270);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Process_Planning_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
