 ...
 * @author Admin
 */
public class Form_Machine_Maintenance_Check_Points_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Machine_Maintenance_Check_Points_List
     */
    public Form_Machine_Maintenance_Check_Points_List() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of  Machine Maintenance CheckPoint");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No.", "Date Of Entry", "Machine Name", "Machine Code", "Peventive Check To Be Carried Out", "Location", "Frequency", "Tools/Equipment To Be Used", "Start Date", "Actual Date Of Entry", "Actual Time ", "User"
            }
        ));
        jTable2.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jTable2.setMinimumSize(new java.awt.Dimension(600, 405));
        jTable2.setPreferredSize(new java.awt.Dimension(1400, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Machine_Maintenance_Check_Points_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
