 ...
 * @author Kamod
 */
public class Form_Purchase_Order_to_supplier_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Purchase_Order_to_supplier_List
     */
    public Form_Purchase_Order_to_supplier_List() {
        initComponents();
          this.setExtendedState(JFrame.MAXIMIZED_BOTH);
        // this.setLayout(new GridBagLayout());
         //this.add(jScrollPane3, new GridBagConstraints());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of  Supplier Purchase Orders");
        ...
        jTable2.setPreferredSize(new java.awt.Dimension(4250, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Purchase_Order_to_supplier_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
