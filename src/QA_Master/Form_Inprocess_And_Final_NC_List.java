 ...
 * @author Owner
 */
public class Form_Inprocess_And_Final_NC_List extends javax.swing.JFrame {

    /**
     * Creates new form Form_Inprocess_And_Final_NC_List
     */
    public Form_Inprocess_And_Final_NC_List() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List  Of  InProcess & Final NC");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No.", "Date Of Entry", "Stage Of Manufacturing", "Non-Confirmity Observed", "Action Taken On Non-Confirming Product", "Root Cause", "Action Taken To Prevent Recurrence", "Responsbility", "Target Date", "Completion status", "Verification Date", "Actual Date Of Entry", "Actual Time ", "User"
            }
        ));
        jTable2.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jTable2.setMinimumSize(new java.awt.Dimension(2147483647, 405));
        jTable2.setPreferredSize(new java.awt.Dimension(1900, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Inprocess_And_Final_NC_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
